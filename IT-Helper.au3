...
;local $dir_distr, $dir_log, $dir_enot, $changelog, $user, $pass, $Server
local $title = _update()
...
#Region ### Начало - Кнопки ###
	...
	$btnInstall = GUICtrlCreateButton("Установить", 493, 404, 131, 33, BitOR($BS_DEFPUSHBUTTON,$BS_PUSHLIKE))
	GUICtrlSetFont(-1, 10, 400, 0, "Arial Narrow")
	GUICtrlSetColor(-1, 0x000000)
